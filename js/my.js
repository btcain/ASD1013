...
var otherId = []
      ...
      var contentCreator = '<li id="' + id + '" data-theme="d" class="ui-li ui-li-static ui-btn-up-d ui-first-child ui-last-child"> <center><h5> ' + name + '</h5> </center> <table border="0" bordercolor="#000000" style="background-color:#FFFFFF; font-weight:normal" width="100%" cellpadding="3" cellspacing="3" ><tr><td>Item Cost</td><td>' + cost + '</td></tr><tr><td>Shop</td><td>' + shop + '</td></tr><tr><td>Item Type</td><td>' + itemType + '</td></tr><tr><td>Released on</td><td>' + released + '</td></tr><tr><td>Retired?</td><td>' + retired + '</td></tr><tr><td>Notes</td><td>' + notes + '</td></tr><tr><td><a id="editClick" href="#new" data-role="button" onClick="editMe(' + i + ')">Editor?</button></td><td><a id="deleteMe" data-role="button" href="#" onClick="deleteMe(' + i + ')">Delete</button></td></tr></table> </li>';
